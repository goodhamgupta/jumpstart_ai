defmodule JumpstartAiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JumpstartAiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JumpstartAiWeb.Gettext, "errors", msg, opts)
    end
  end
