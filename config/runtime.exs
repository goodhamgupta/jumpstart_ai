...
config :jumpstart_ai,
  ...
  google_client_secret:
    System.get_env("GOOGLE_CLIENT_SECRET") || raise("Missing GOOGLE_CLIENT_SECRET"),
  google_redirect_uri:
...
#
#     PHX_SERVER=true bin/jumpstart_ai start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :jumpstart_ai, JumpstartAiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :jumpstart_ai, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
